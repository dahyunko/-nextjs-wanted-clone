...
const Article_info = [
    {
        ...
        main_img: 'https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fbanners%2Fthemes%2F443_39c92dfe.jpg&w=520&q=100' , 
        com_img:[
    ...
    },
    {
        ...
        main_img: 'https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fbanners%2Fthemes%2F264_aa39c308.png&w=520&q=100' , 
        com_img:[
            'https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fwdes%2F0_4.b9f09c72.jpg&w=42&q=100',
            'https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fwdes%2F0_4.b9f09c72.jpg&w=42&q=100',
            'https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fwdes%2F0_4.b9f09c72.jpg&w=42&q=100',    
                    ...
                    <a href="" className='block w-full'>
                        ...
                        <div className='block mt-5 ml-2'>
                            <div className='flex flex-col justify-between mb-3'>
                                ...
                                <span className='text-gray-500 text-lg font-semibold'>{Data.contents}</span>
                            </div>
                            <div className='flex'>
                                {
                                    Data.com_img.map((Icon, index) =>{
                                        return(
                                            // eslint-disable-next-line react/jsx-key
                                            <img key={index} className='mr-2 border-2 border-gray-300 w-10 h-10' src={Icon} alt="" />
                                        );
                                    })
                                }
                            </div>
