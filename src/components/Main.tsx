                    ...
                    <div className="">
                        <div>
                            <div className='relative inline-block w-full mt-5'>
                                <div className="">
                                    <a className=''>
                                        <img className='rounded-md h-auto w-full' src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fbanners%2F2070%2F1c7540fe.jpg&w=1060&q=100"></img>
                                    </a>
                                </div>
                                <div className="absolute bottom-0 left-0 m-6 bg-white rounded-md w-96">
                                    <div className='p-6'>
                                        <h2 className='text-2xl font-bold'>누적 150억 투자받은 XYZ</h2>
                                        <h3 className='text-lg'>로봇으로 바꾸는 일상, 함께 만들어요.</h3>
                                    </div>
                                    <hr />
                                    <a href="" className='px-6 py-4 text-blue-500 flex items-center' >
                    ...
                    <aside className="mt-16">
                        <div className="flex justify-center items-center mt-24 h-16 ">
                            <a className='bg-gradient-to-r from-blue-500 via-blue-700 to-blue-500 text-white rounded-full w-full py-5  px-3 text-center text-bold text-xl'>
                                ...
                                <span className="text-2lg font-bold" >채용 중인 포지션 보러가기</span>
                            </a>
                        </div>
                    </aside>
                        ...
                        <div className="flex  justify-center">
                            <div 
                                ...
                                <div className="flex rounded-2xl justify-between items-center p-9 h-40 bg-gradient-to-r from-neutral-50 via-green-50 to-neutral-50">
                                    <ul>
                                        <li className='text-2xl font-bold'>내가 관심있을 만한 포지션</li>
                                        <li className='text-xl font-medium text-gray-500'>회원가입 후, 이력서와 포지션 분석을 통해 적절한 포지션을 추천받으세요!</li>
                                    </ul>
                                    <button className="rounded-full text-white bg-blue-500 h-14 text-center w-52 font-semibold ">지금 시작하기</button>
                                </div>
                        ...
                        <div className="flex h-32 w-full">
                            <div className="inline-block align-middle w-full">
                                <div className="flex rounded-2xl justify-between items-center bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 p-9">
                                    <div className="text-white text-2xl font-bold ">내 연차에 이 연봉이 괜찮은가? 궁금할 땐</div>
                                    <button className="bg-white rounded-full p-2 text-blue-500 h-14 w-52 font-semibold">커리어 중간점검</button>
                                </div>
                            </div>
                        </div>
                    </article>
